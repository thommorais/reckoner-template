	...
	return (
		<Headless.Dialog {...props}>
			<Headless.DialogBackdrop
				transition
				className='fixed inset-0 flex w-screen justify-center overflow-y-auto bg-black/15 px-2 py-2 transition duration-100 focus:outline-0 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in sm:px-6 sm:py-8 lg:px-8 lg:py-16'
			/>
